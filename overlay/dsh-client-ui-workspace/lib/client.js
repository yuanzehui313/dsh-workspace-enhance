window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** Locale-aware sidebar label for the ungrouped bucket (zh → 未分组). */
		function ungroupedLabel() {
			return typeof navigator !== "undefined" && [...navigator.languages ?? [], navigator.language].some((tag) => typeof tag === "string" && tag.toLowerCase().startsWith("zh")) ? "未分组" : UNGROUPED_LABEL;
		}
		...
		function deriveGroups(list, workspaces, archivedSessionIds, view) {
			...
			for (const g of groupByWorkspace(list, workspaces, archived, view.ungroupedOrder)) {
				...
				groups.push({
					...
					label: g.key === "" ? ungroupedLabel() : g.label,
													...
													gitMenuPath === root.path && (0, react_jsx_runtime.jsxs)("div", {
														...
														children: [
															...
															(0, react_jsx_runtime.jsxs)("div", {
																...
																}, branch)), (gitByPath[root.path]?.remoteBranches ?? []).length > 0 && (0, react_jsx_runtime.jsx)("div", { className: WorkspaceBrowser_module_css_default.gitBranchHead, children: t("git.remoteBranches") }), ...(gitByPath[root.path]?.remoteBranches ?? []).map((branch) => (0, react_jsx_runtime.jsxs)("div", { className: clsx(WorkspaceBrowser_module_css_default.gitBranchRow, WorkspaceBrowser_module_css_default.gitRemoteRow), role: "button", title: t("git.checkoutRemote") + ": " + branch, onClick: () => { if (gitBusyPath !== null) return; runGitOp(root.path, () => gitCheckoutRemote(root.path, branch)); }, children: [branch, (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLinkOutline16, { size: 12 })] }, "r-" + branch))]
															}),
															(0, react_jsx_runtime.jsxs)("div", {
...
gitPushPreviewState !== null && gitPushPreviewState.path === root.path && (0, react_jsx_runtime.jsxs)("div", {
								...
								(0, react_jsx_runtime.jsxs)("div", {
									...
									(0, react_jsx_runtime.jsx)("div", {
										style: { margin: "4px 8px 6px", border: "1px dashed rgba(167,139,250,0.45)", borderRadius: 6, padding: "8px 10px", fontSize: 12, color: "var(--dsw-alias-label-secondary)", textAlign: "center", minHeight: 34, display: filesCollapsed ? "none" : "flex", alignItems: "center", justifyContent: "center" },
		...
		*/
		...
		const zh = {
			...
			"git.checkoutRemote": "从远程分支创建并切换（更新本地代码）",
			"git.stash": "暂存区",
			"git.stashPush": "暂存改动",
			"git.stashPop": "恢复最近",
			"git.prDraft": "生成 PR",
		...
		const en = {
			...
			"git.checkoutRemote": "Create & switch from remote (updates local code)",
			"git.stash": "Stash",
		...
		*/
		function apply(ctx) {
			...
			const browserInjected = () => ({
				...
				gitCheckoutRemote: (path, branch) => ctx.workspaces.gitCheckoutRemote(path, branch),
