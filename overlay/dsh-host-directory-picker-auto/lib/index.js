...
function resolveDirectoryPickerBackend(facts) {
	...
	// Windows prefers the in-app browse surface: the native backend drives the
	// OS chooser through a Node console window, which reads as an unfriendly
	// popup on every pick. The browse backend works everywhere.
